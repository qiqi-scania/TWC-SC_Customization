...
export const API_CALL_SET_ASR_ICON = 'set_asr_icon';
export const API_CALL_RESET_ASR_ICON = 'reset_asr_icon';
export const API_CALL_HIDE_ASR_BUTTON = 'hide_asr_button';
export const API_CALL_SHOW_ASR_BUTTON = 'show_asr_button';
export const API_CALL_ENABLE_ASR_BUTTON = 'enable_asr_button';
export const API_CALL_DISABLE_ASR_BUTTON = 'disable_asr_button';
export const API_CALL_ASR_ACTIVE = 'asr_active';
export const API_CALL_ASR_INACTIVE = 'asr_inactive';
export const API_CALL_SET_TTS_ICON = 'set_tts_icon';
export const API_CALL_RESET_TTS_ICON = 'reset_tts_icon';
export const API_CALL_HIDE_TTS_BUTTON = 'hide_tts_button';
export const API_CALL_SHOW_TTS_BUTTON = 'show_tts_button';
export const API_CALL_ENABLE_TTS_BUTTON = 'enable_tts_button';
export const API_CALL_DISABLE_TTS_BUTTON = 'disable_tts_button';
export const API_CALL_TTS_ACTIVE = 'tts_active';
export const API_CALL_TTS_INACTIVE = 'tts_inactive';
